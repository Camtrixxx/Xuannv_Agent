...
AEF_CONFIG=/data/heyuhang/yajiang-aef/configs/yajiang_v1_2_continue_200.yaml \
AEF_MANIFEST=/data/heyuhang/yajiang-aef/data/full_npy/train.jsonl \
AEF_DEPLOY_MODEL=/data/heyuhang/yajiang-aef/outputs/aef_hyh_yajiang_v1_2_continue_200/exports/aef_hyh_yajiang_v1_2_continue_200_deploy.pt \
AEF_CACHE_DIR=/data/heyuhang/yajiang-aef/outputs/aef_inference_service_v1_2_continue_200 \
AEF_DEVICE=auto \
scripts/start_aef_inference_service.sh
```

也可以直接运行服务模块。直接运行时会读取上述环境变量；未设置时默认复用
`/data/heyuhang/yajiang-aef` 下的 `v1_2_continue_200` 模型资源：
